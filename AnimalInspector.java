		...
		*/
		...
		public abstract class AnimalInspector extends JPanel
		    {
		                ...
		                SwingUtilities.invokeLater(new Runnable()
		                    ...
		                    public void run()
		                        ...
		                        synchronized(state.schedule)
		                            {
		                            AnimalInspector.this.updateInspector();
		                            AnimalInspector.this.repaint();
		                            }
		                        }
		                    });
		                }
		    ...
		    */
		    ...
		    static ImageIcon iconFor(String name)
		        {
		        return new ImageIcon(AnimalInspector.class.getResource(name));
		        }
